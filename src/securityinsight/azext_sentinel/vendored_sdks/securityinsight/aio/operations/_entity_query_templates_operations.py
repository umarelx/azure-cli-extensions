...
class EntityQueryTemplatesOperations:
    ...
    def list(
        ...
        **kwargs
    ) -> AsyncIterable["models.EntityQueryTemplateList"]:
        ...
        :return: An iterator like instance of either EntityQueryTemplateList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.securityinsight.models.EntityQueryTemplateList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.EntityQueryTemplateList"]
        error_map = {
    ...
    async def get(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.EntityQueryTemplate"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        path_format_arguments = {
            ...
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str', max_length=90, min_length=1),
            'entityQueryTemplateId': self._serialize.url("entity_query_template_id", entity_query_template_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
