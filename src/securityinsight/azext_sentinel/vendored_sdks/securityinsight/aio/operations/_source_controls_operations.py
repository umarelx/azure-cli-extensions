...
class SourceControlsOperations:
    ...
    def list(
        ...
        workspace_name: str,
        **kwargs
    ) -> AsyncIterable["models.SourceControlList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.securityinsight.models.SourceControlList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SourceControlList"]
        error_map = {
    ...
    async def get(
        ...
        **kwargs
        ...
        path_format_arguments = {
            ...
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str', max_length=90, min_length=1),
            'sourceControlId': self._serialize.url("source_control_id", source_control_id, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    async def create(
        ...
        **kwargs
        ...
        body_content = self._serialize.body(source_control, 'SourceControl')
