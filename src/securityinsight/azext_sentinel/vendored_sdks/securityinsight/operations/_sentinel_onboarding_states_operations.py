...
class SentinelOnboardingStatesOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.SentinelOnboardingState"
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SentinelOnboardingState"]
        error_map = {
        ...
        path_format_arguments = {
            ...
            'sentinelOnboardingStateName': self._serialize.url("sentinel_onboarding_state_name", sentinel_onboarding_state_name, 'str'),
        }
    ...
    def create(
        ...
        workspace_name,  # type: str
        sentinel_onboarding_state_name,  # type: str
        sentinel_onboarding_state_parameter=None,  # type: Optional["models.SentinelOnboardingState"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.SentinelOnboardingState"
        ...
        :type sentinel_onboarding_state_parameter: ~azure.mgmt.securityinsight.models.SentinelOnboardingState
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SentinelOnboardingState, or the result of cls(response)
        :rtype: ~azure.mgmt.securityinsight.models.SentinelOnboardingState
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        if sentinel_onboarding_state_parameter is not None:
            body_content = self._serialize.body(sentinel_onboarding_state_parameter, 'SentinelOnboardingState')
        else:
            body_content = None
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.SentinelOnboardingStatesList"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SentinelOnboardingStatesList"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
