...
class ThreatIntelligenceIndicatorOperations(object):
    ...
    def create_indicator(
        ...
        threat_intelligence_properties,  # type: "models.ThreatIntelligenceIndicatorModel"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.ThreatIntelligenceInformation"
        ...
        :param threat_intelligence_properties: Properties of threat intelligence indicators to create
         and update.
        :type threat_intelligence_properties: ~azure.mgmt.securityinsight.models.ThreatIntelligenceIndicatorModel
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ThreatIntelligenceInformation"]
        error_map = {
        ...
        # Construct URL
        url = self.create_indicator.metadata['url']  # type: ignore
        ...
        body_content = self._serialize.body(threat_intelligence_properties, 'ThreatIntelligenceIndicatorModel')
    ...
    def query_indicators(
        ...
        resource_group_name,  # type: str
        workspace_name,  # type: str
        threat_intelligence_filtering_criteria,  # type: "models.ThreatIntelligenceFilteringCriteria"
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.ThreatIntelligenceInformationList"]
        ...
        :type threat_intelligence_filtering_criteria: ~azure.mgmt.securityinsight.models.ThreatIntelligenceFilteringCriteria
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either ThreatIntelligenceInformationList or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.securityinsight.models.ThreatIntelligenceInformationList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ThreatIntelligenceInformationList"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.query_indicators.metadata['url']  # type: ignore
                path_format_arguments = {
                    'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
                    'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
                    'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str', max_length=90, min_length=1),
    ...
    def append_tags(
        ...
        workspace_name,  # type: str
        name,  # type: str
        threat_intelligence_append_tags,  # type: "models.ThreatIntelligenceAppendTags"
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        ...
        :type threat_intelligence_append_tags: ~azure.mgmt.securityinsight.models.ThreatIntelligenceAppendTags
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: None, or the result of cls(response)
        :rtype: None
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        # Construct URL
        url = self.append_tags.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str', max_length=90, min_length=1),
    ...
    def replace_tags(
        ...
        workspace_name,  # type: str
        name,  # type: str
        threat_intelligence_replace_tags,  # type: "models.ThreatIntelligenceIndicatorModel"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.ThreatIntelligenceInformation"
        ...
        :param threat_intelligence_replace_tags: Tags in the threat intelligence indicator to be
         replaced.
        :type threat_intelligence_replace_tags: ~azure.mgmt.securityinsight.models.ThreatIntelligenceIndicatorModel
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: ThreatIntelligenceInformation, or the result of cls(response)
        :rtype: ~azure.mgmt.securityinsight.models.ThreatIntelligenceInformation
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        # Construct URL
        url = self.replace_tags.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str', max_length=90, min_length=1),
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(threat_intelligence_replace_tags, 'ThreatIntelligenceIndicatorModel')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
