...
class EntitiesGetTimelineOperations(object):
    ...
    def list(
        ...
        entity_id,  # type: str
        parameters,  # type: "models.EntityTimelineParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.EntityTimelineResponse"
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.EntityTimelineResponse"]
        error_map = {
        ...
        body_content = self._serialize.body(parameters, 'EntityTimelineParameters')
