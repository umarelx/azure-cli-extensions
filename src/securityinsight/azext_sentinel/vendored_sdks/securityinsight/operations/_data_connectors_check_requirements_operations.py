...
class DataConnectorsCheckRequirementsOperations(object):
    ...
    def post(
        ...
        data_connectors_check_requirements,  # type: "models.DataConnectorsCheckRequirements"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.DataConnectorRequirementsState"
        ...
        :type data_connectors_check_requirements: ~azure.mgmt.securityinsight.models.DataConnectorsCheckRequirements
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DataConnectorRequirementsState"]
        error_map = {
