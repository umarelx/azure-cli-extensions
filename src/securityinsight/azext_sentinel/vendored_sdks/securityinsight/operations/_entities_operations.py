...
class EntitiesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.EntityList"]
        """Gets all entities.
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.EntityList"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.Entity"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def expand(
        ...
        workspace_name,  # type: str
        entity_id,  # type: str
        parameters,  # type: "models.EntityExpandParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.EntityExpandResponse"
        """Expands an entity.
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.EntityExpandResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def queries(
        ...
        workspace_name,  # type: str
        entity_id,  # type: str
        kind,  # type: Union[str, "models.EntityItemQueryKind"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.GetQueriesResponse"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.GetQueriesResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        # Construct URL
        url = self.queries.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', min_length=1),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str', max_length=90, min_length=1),
    ...
    def get_insights(
        ...
        workspace_name,  # type: str
        entity_id,  # type: str
        parameters,  # type: "models.EntityGetInsightsParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.EntityGetInsightsResponse"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.EntityGetInsightsResponse"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(parameters, 'EntityGetInsightsParameters')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        pipeline_response = self._client._pipeline.run(request, stream=False, **kwargs)
        response = pipeline_response.http_response
