...
class SourceControlOperations(object):
    ...
    def list_repositories(
        ...
        repo_type,  # type: Union[str, "models.RepoType"]
        **kwargs  # type: Any
    ):
        # type: (...) -> Iterable["models.RepoList"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.RepoList"]
        error_map = {
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_repositories.metadata['url']  # type: ignore
                ...
                body_content = self._serialize.body(repo_type, 'str')
