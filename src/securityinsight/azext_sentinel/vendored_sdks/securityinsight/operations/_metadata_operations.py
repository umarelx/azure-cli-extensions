...
class MetadataOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.MetadataList"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.MetadataList"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.MetadataModel"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def create(
        ...
        workspace_name,  # type: str
        metadata_name,  # type: str
        metadata,  # type: "models.MetadataModel"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MetadataModel"
        """Create a Metadata.
        ...
        body_content = self._serialize.body(metadata, 'MetadataModel')
    ...
    def update(
        ...
        workspace_name,  # type: str
        metadata_name,  # type: str
        metadata_patch,  # type: "models.MetadataPatch"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.MetadataModel"
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(metadata_patch, 'MetadataPatch')
        body_content_kwargs['content'] = body_content
