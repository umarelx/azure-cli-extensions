...
class IncidentsOperations(object):
    ...
    def run_playbook(
        ...
        incident_identifier,  # type: str
        request_body=None,  # type: Optional["models.ManualTriggerRequestBody"]
        **kwargs  # type: Any
    ):
        # type: (...) -> object
    ...
    def create_team(
        ...
        workspace_name,  # type: str
        incident_id,  # type: str
        team_properties,  # type: "models.TeamProperties"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.TeamInformation"
    ...
    def list_bookmarks(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.IncidentBookmarkList"
    ...
    def list_entities(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.IncidentEntitiesResponse"
