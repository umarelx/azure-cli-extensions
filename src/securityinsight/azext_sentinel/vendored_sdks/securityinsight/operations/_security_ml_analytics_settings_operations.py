...
class SecurityMlAnalyticsSettingsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.SecurityMlAnalyticsSettingsList"]
        ...
        :return: An iterator like instance of either SecurityMlAnalyticsSettingsList or the result of cls(response)
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.securityinsight.models.SecurityMlAnalyticsSettingsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SecurityMlAnalyticsSettingsList"]
        error_map = {
    ...
    def get(
        ...
        resource_group_name,  # type: str
        workspace_name,  # type: str
        settings_resource_name,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.SecurityMlAnalyticsSetting"
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SecurityMlAnalyticsSetting"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
        ...
        path_format_arguments = {
            ...
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str', max_length=90, min_length=1),
            'settingsResourceName': self._serialize.url("settings_resource_name", settings_resource_name, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    def create_or_update(
        ...
        workspace_name,  # type: str
        settings_resource_name,  # type: str
        security_ml_analytics_setting,  # type: "models.SecurityMlAnalyticsSetting"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.SecurityMlAnalyticsSetting"
        ...
        :type security_ml_analytics_setting: ~azure.mgmt.securityinsight.models.SecurityMlAnalyticsSetting
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SecurityMlAnalyticsSetting, or the result of cls(response)
        :rtype: ~azure.mgmt.securityinsight.models.SecurityMlAnalyticsSetting
        :raises: ~azure.core.exceptions.HttpResponseError
        ...
        body_content = self._serialize.body(security_ml_analytics_setting, 'SecurityMlAnalyticsSetting')
